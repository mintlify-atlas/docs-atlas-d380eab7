---
title: "Prepare the Patched SDI File for BitUnlocker"
sidebarTitle: "Prepare SDI"
description: "How to obtain or build the boot_patched.sdi file used by BitUnlocker: download from Releases or build with patch_sdi.py from a stock boot.sdi and WinRE.wim."
---
